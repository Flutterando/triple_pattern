...
An mixin which automatically persists and restores store state. 
...
### Step 2: Add a Serializable contract in your State class. (If be not primitive value). 
```dart
...
### Step 2: Implements a HydratedDelegate or use **hydrated_triple**.
