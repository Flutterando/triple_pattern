...
## Execute Either (**EitherAdapter**) {#-execute-either-eitheradapter}
...
### Step 1 - Create Adapter: {#-step-1---create-adapter}

```dart
class CustomEitherAdapter implements EitherAdapter {}
```

### Step 2 - Add Left and Right type: {#-step-2---add-left-and-right-type}

```dart
class CustomEitherAdapter<R, L> implements EitherAdapter<R, L> {}
```

### Step 3 - Implement fold method (Using dartz or any other functional package): {#-step-3---implement-fold-method-using-dartz-or-any-other-functional-package}
...
### Step 4 - Just use: {#-step-4---just-use}
