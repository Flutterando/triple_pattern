...
## Segmented State Pattern (SSP) {#-segmented-state-pattern-ssp}
...
## Single Flow Pattern (BLoC and Flux/Redux) {#-single-flow-pattern-bloc-and-fluxredux}
.
![schema](./bloc.png)
...
## Targeting the state in State, Error, Loading {#-targeting-the-state-in-state-error-loading}
.
![schema](schema.png)
...
## Seeing the Flows {#-seeing-the-flows}
